...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/blog/view', title: 'Blogs',  icon:'ni ni-book-bookmark text-blue', class: '' },
    ...
    // { path: '/career/view', title: 'Career',  icon:'ni ni-bulb-61 text-yellow', class: '' },
    ...
    // { path: '/service/view', title: 'Services',  icon: 'ni ni-settings text-red', class: '' },
    // { path: '/position/view', title: 'Positions',  icon: 'ni-bullet-list-67 text-red', class: '' },
